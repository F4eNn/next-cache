...
const PostPage = async ({ params }: { params: { post: string[] } }) => {
	...
	return <main className='mb-32'>{tytul}
    <Image src={galeria.data[0].attributes.url} width={400} height={500} className='h-56 w-56 object-cover' alt=''/>
    <Image src={galeria.data[1].attributes.url} width={400} height={500} className='h-56 w-56 object-cover' alt=''/>
    <Image src={galeria.data[2].attributes.url} width={400} height={500} className='h-56 w-56 object-cover' alt=''/>
    <Image src={galeria.data[3].attributes.url} width={400} height={500} className='h-56 w-56 object-cover' alt=''/>
    <Image src={galeria.data[4].attributes.url} width={400} height={500} className='h-56 w-56 object-cover' alt=''/>
    <Image src={galeria.data[5].attributes.url} width={400} height={500} className='h-56 w-56 object-cover' alt=''/>
    </main>;
